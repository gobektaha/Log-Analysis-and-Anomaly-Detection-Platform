...
* **Kalıcı Veri Depolama:** Tespit edilen anomaliler ve üretilen normal loglar, Django ORM yapısı kullanılarak hafif ve performanslı SQLite veritabanına kaydedilir.
